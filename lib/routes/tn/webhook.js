...
import { getOrder } from '../../tn.js';
import { upsertOrderFromTN, attributeOrder, reverseOrderAttribution, markSegmentPaid, markSegmentCancelled } from '../../attribution.js';
    ...
    switch (event) {
      ...
      case 'order/paid': {
        ...
        if (tnOrder) {
          ...
          await markSegmentPaid(order);  // reflect payment in the guided AM order
        }
        break;
      }
      case 'order/cancelled': {
        ...
        if (tnOrder) {
          ...
          await markSegmentCancelled(order);
        }
        break;
      }
