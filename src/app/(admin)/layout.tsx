      ...
      <header className="border-b border-white/8 bg-black">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-xs text-white/40">
            ...
            <Link href="/admin/verificaciones" className="hover:text-white transition-colors">Verificaciones</Link>
            <Link href="/admin/marcas" className="hover:text-white transition-colors">Marcas</Link>
